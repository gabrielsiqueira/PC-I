...
//Numa conta de saldo mínimo, uma taxa de serviço é deduzida se a conta cai abaixo
//de certa quantia especificada.
...
// Se não houver fundos, imprima número da conta e a mensagem “ NÃO HÁ FUNDOS ”;
